    ...
    <div className='container-fluid'>
      ...
      <div className='container p-4 my-3 bg-body-tertiary'>
        ...
        <p>
          ...
          specializes in providing a wide range of high-quality and
          cost-effective outsourcing services to businesses across various
          industries. Established in May 27, 2023.{" "}
        </p>
        <p>
        ...
        <p>
          Our goal is to continue being a management that keeps the business
          grow and continuously maintains and improves the quality of lives of
      ...
      <div className='row p-4'>
        <div className='col-6'>
          ...
          <p className='p-4'>
            To provide cost-effective and high-quality IT solutions that best
            define the requirements of our clients while ensuring that we
            continue to provide career and skill advancement opportunities to
            our employees.
          </p>
          <h1 className='p-4'>VISION</h1>
          <p className='p-4'>
            To be the most trusted outsourcing IT company that markets one-stop
            software development services globally and provides more job
            opportunities to Filipino people.
          </p>
        </div>
        <div className='col-6'>
          {" "}
          <img src={visionImg} alt='visionImg' width={700} />
        </div>
      </div>
      <div className='row p-4'>
        ...
        <div className='col-6 p-4'>
          ...
          <p>
            <b>We have integrity.</b>
          </p>
          <p>
            We always do what is right, even if, and especially if no one is
            looking.
          </p>
        </div>
        <div className='col-6 p-4'>
      ...
      <div className='row p-4'>
        ...
        <div className='col-6 col-md-4 my-5'>
          <b>Sir Prince Portfolio</b>
        </div>
        <div className='col-6 col-md-4 my-5'>
          <b>Sir Melvin Portfolio</b>
        </div>
        <div className='col-6 col-md-4 my-5'>
          <b>Portfolio ko</b>
        </div>
