...
import Pragress from "../assets/img/pragress.jpg"
import Development from "../assets/img/development.jpg"
import Recruite from "../assets/img/recruite.jpg"
import Employee from "../assets/img/employee.jpg"
import Onsite from "../assets/img/onsite.jpg"
import Carrer from "../assets/img/career.jpg"
import Hybrid from "../assets/img/hybrid.jpg"
import Workhome from "../assets/img/workhome.jpg"
import Glenn from "../assets/img/glenn.jpg"
    ...
    <div class='container-fluid'>
          ...
          <Row>
            <Col sm='4' xs='6'>
              <Table border={2} size='sm w-100'>
                ...
                <tbody>
                  <tr>
                    <td class='table1'>Full-Time Job</td>
      ...
      <div class='container'>
        ...
        <Row className='rowrow'>
          <Col sm='4' xs='6'>
            <Card>
              <CardImg alt='Card image cap' src={Onsite} />
              <CardBody>
                <CardTitle className='cardtitle'>Work Onsite</CardTitle>
                <CardText className='cardtext'>
                  Working on location allows you to work as part of a team,
                  increasing collaboration and improving productivity.
                </CardText>
              </CardBody>
            </Card>
          </Col>
          ...
          <Col sm='4' xs='6'>
            <Card>
              <CardImg alt='Card image cap' src={Hybrid} />
              <CardBody>
                <CardTitle className='cardtitle'>Hybrid</CardTitle>
                <CardText className='cardtext'>
                  Hybrid work is a flexible work model that supports a blend of
                  in-office, remote, and on-the-go workers.
                </CardText>
              </CardBody>
            </Card>
          </Col>
          ...
          <Col sm='4' xs='6'>
            <Card>
              ...
              />
              <CardBody>
                <CardTitle className='cardtitle'>Work from Home</CardTitle>
                <CardText className='cardtext'>
                  Employees work from home by using a dedicated laptop/PC
                  connected to the internet to communicate with team members.
                </CardText>
              </CardBody>
            </Card>
          </Col>
      ...
      <div class='container'>
        ...
        <Row>
          <Col sm='4' xs='6'>
            ...
            <h5 class='mb-2 prince'>
              <strong>
                <h2>Prince</h2>
              </strong>
            </h5>
            <p class='text-muted detailsprince'>
          ...
          <Col sm='4' xs='6'>
            ...
            <p class='text-muted detailsglen'>
              Web designer <span class='badge bg-primary'>PRO</span>
            </p>
          </Col>
          <Col sm='4'>
            ...
            <h5 class='mb-2 melvin'>
              <strong>
                <h2>Melvin</h2>
              </strong>
            </h5>
            <p class='text-muted detailsmelvin'>
              Web designer <span class='badge bg-primary'>PRO</span>
            </p>
          </Col>
        </Row>
        <div>
          <button
            type='button'
            class='btn btn-outline-success w-25 meetus m-auto'
          >
            MEET OUR TEAM
          </button>
        </div>
