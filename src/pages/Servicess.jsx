...
import DevProcessImg from "../assets/img/devprocess.jpg"
...
import Rails from "../assets/img/rails.webp"
import Cube from "../assets/img/cube.webp"
import Symphony from "../assets/img/symfony.webp"
import Sass from "../assets/img/sass.webp"
import Fastapi from "../assets/img/fastapi.webp"
import Nuxtjs from "../assets/img/nuxtjs.webp"
import ReacT from "../assets/img/react.webp"
import Vue from "../assets/img/vue.webp"
import Nodejs from "../assets/img/node.webp"
import Mysql from "../assets/img/mysql.webp"
import Postre from "../assets/img/postgre.webp"
import Maria from "../assets/img/mariadb.webp"
import Oracle from "../assets/img/oracle.webp"
  ...
  return (
    <div class='container-fluid'>
      ...
      <Card inverse>
        ...
        />
        <CardImgOverlay>
          <CardTitle tag='h1' className='p-5'></CardTitle>
        </CardImgOverlay>
      </Card>

      <div className='container'>
        <List>
          <h1 className='p-4'>Our Strengths and Features:</h1>
          <li className='p-2'>
      ...
      <div className='container'>
            ...
            <Col sm='6' xs='6'>
              <List type='unlist'>
                <ListInlineItem className='p-2'>
                  ...
                  websites; it’s the work that goes on behind the scenes to make
                  a website appear attractive, work quickly, and provide a
                  consistent user experience. Web developers use a range of
                  coding languages and frameworks to do this. The choice of
                  languages and frameworks is determined by the tasks they’re
                  performing and the platforms they’re using.
                </ListInlineItem>
                <ListInlineItem className='p-2'>
                  Web development talents are in high demand making it an
                  excellent career choice. It is one of the most easily
                  accessible and well-paying fields.
                </ListInlineItem>
                <ListInlineItem className='p-2'>
                  Based on the best practices, our team provides excellent
                  service solutions that are centered around SEO strategies. We
                  deliver faster and reduce cost using the latest techniques.
                </ListInlineItem>
              </List>
            </Col>
          </Row>
        ...
        <div class='container'>
          ...
          <Row>
            ...
            <Col xs='6'>
              <p class='center'>
                We make sure to execute proper planning and smart
                decision-making to deliver the best product to our clients.
                <br></br>
                <br></br>
                As engineer we will not limit your responsibilities and not just
                focus on thinking programming solutions, but you are also
                expected to execute testing or design technical documentations.
                <br></br>
                <br></br>
                We are an agile environment, we deliver insightful and proper
                feedback to our engineers and clients in a timely manner.
                <br></br>
                <br></br>
                We encourage teamwork, innovation, process improvement,
                high-quality output and growth throughout our whole development
                process.<br></br>
                <br></br>
              </p>
            </Col>
        ...
        <div className='container'>
          <h1>
            TECHNOLOGIES<h1>WE ARE USING</h1>
          </h1>
          <br></br>
          <p>
            We always make sure to be on trend when it comes to new
            technologies.
            <br></br>Our employees are open to share and collaborate!
          </p>
        ...
        <div class='container'>
          <Row>
            ...
            <Col xs='6'>
              <p class='join'>
                <h1 class='part'>BE PART OF</h1>{" "}
                <h1 class='part1'>OUR TEAM!</h1>
                <Button className='btn btn-success w-50 p-2'>
                  Explore Job Opportunity
                </Button>
              </p>
            </Col>
          </Row>
